...
const WeatherApp = () => {
  let api_kay = "607b0a68b360d6e6f6cd27f7318d20b7";
  ...
  const search = async () => {
    ...
    const location = document.getElementsByClassName("data-location");
  ...
  return (
    <div className="body">
      <div className="container">
        ...
        <div className="data-location">London</div>
      ...
      <div className="your-text">Created by <br/> Ahmad Housh</div>
    </div>
